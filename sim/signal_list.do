...
wave add -group {SCCB Interface} sccb_master_controller_tb.tx_data -tag F0 -radix hexadecimal -subitemconfig { {sccb_master_controller_tb.tx_data[7]} {-radix hexadecimal} {sccb_master_controller_tb.tx_data[6]} {-radix hexadecimal} {sccb_master_controller_tb.tx_data[5]} {-radix hexadecimal -select} {sccb_master_controller_tb.tx_data[4]} {-radix hexadecimal} {sccb_master_controller_tb.tx_data[3]} {-radix hexadecimal} {sccb_master_controller_tb.tx_data[2]} {-radix hexadecimal} {sccb_master_controller_tb.tx_data[1]} {-radix hexadecimal} {sccb_master_controller_tb.tx_data[0]} {-radix hexadecimal} }
...
wave add sccb_master_controller_tb.sccb_master_controller.sccb_fsm.phase_cnt_q -tag F0 -radix hexadecimal -select
